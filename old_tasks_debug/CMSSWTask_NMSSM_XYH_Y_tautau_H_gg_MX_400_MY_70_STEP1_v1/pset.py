...
process.externalLHEProducer = cms.EDProducer("ExternalLHEProducer",
    args = cms.vstring('../../NMSSM_XYH_Y_tautau_H_gg_MX_400_MY_70_slc7_amd64_gcc700_CMSSW_10_6_19_tarball.tar.xz'),
...
if hasattr(process,"eventMaker"):
    ...
    process.eventMaker.datasetName = cms.string('/NMSSM_XYH_Y_tautau_H_gg_MX_400_MY_70_STEP1')
