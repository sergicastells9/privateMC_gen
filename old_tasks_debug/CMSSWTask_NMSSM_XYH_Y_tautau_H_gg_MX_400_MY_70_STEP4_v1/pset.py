...
# with command line options: --python_filename HIG-RunIISummer20UL18HLT-00001_1_cfg.py --eventcontent RAWSIM --customise Configuration/DataProcessing/Utils.addMonitoring --datatier GEN-SIM-RAW --fileout file:HIG-RunIISummer20UL18HLT-00001.root --conditions 102X_upgrade2018_realistic_v15 --customise_commands process.source.bypassVersionCheck = cms.untracked.bool(True) --step HLT:2018v32 --geometry DB:Extended --filein file:HIG-RunIISummer20UL18DIGIPremix-00001.root --era Run2_2018 --no_exec --mc -n 813 --nThreads 1
...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file:HIG-RunIISummer20UL18DIGIPremix-00001.root'),
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:HIG-RunIISummer20UL18HLT-00001.root'),
...
if hasattr(process,"eventMaker"):
    ...
    process.eventMaker.datasetName = cms.string('/NMSSM_XYH_Y_tautau_H_gg_MX_400_MY_70_STEP4')
