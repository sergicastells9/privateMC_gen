...
# with command line options: --python_filename HIG-RunIISummer20UL18RECO-00001_1_cfg.py --eventcontent AODSIM --customise Configuration/DataProcessing/Utils.addMonitoring --datatier AODSIM --fileout file:HIG-RunIISummer20UL18RECO-00001.root --conditions 106X_upgrade2018_realistic_v11_L1v1 --step RAW2DIGI,L1Reco,RECO,RECOSIM,EI --geometry DB:Extended --filein file:HIG-RunIISummer20UL18HLT-00001.root --era Run2_2018 --runUnscheduled --no_exec --mc -n 1740 --nThreads 1
...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file:HIG-RunIISummer20UL18HLT-00001.root'),
...
process.AODSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:HIG-RunIISummer20UL18RECO-00001.root'),
...
if hasattr(process,"eventMaker"):
    process.eventMaker.CMS3tag = cms.string('v1')
    process.eventMaker.datasetName = cms.string('/NMSSM_XYH_Y_tautau_H_gg_MX_400_MY_70_STEP5')
