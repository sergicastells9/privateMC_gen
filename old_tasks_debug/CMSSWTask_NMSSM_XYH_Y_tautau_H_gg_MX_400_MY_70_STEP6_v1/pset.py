...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file:HIG-RunIISummer20UL18RECO-00001.root'),
...
process.MINIAODSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:HIG-RunIISummer20UL18MiniAOD-00001.root'),
...
if hasattr(process,"eventMaker"):
    ...
    process.eventMaker.datasetName = cms.string('/NMSSM_XYH_Y_tautau_H_gg_MX_400_MY_70_STEP6')
