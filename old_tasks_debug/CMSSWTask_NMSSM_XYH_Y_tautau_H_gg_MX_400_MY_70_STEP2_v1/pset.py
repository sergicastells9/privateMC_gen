...
# with command line options: --python_filename HIG-RunIISummer20UL18SIM-00001_1_cfg.py --eventcontent RAWSIM --customise Configuration/DataProcessing/Utils.addMonitoring --datatier GEN-SIM --fileout file:HIG-RunIISummer20UL18SIM-00001.root --conditions 106X_upgrade2018_realistic_v11_L1v1 --beamspot Realistic25ns13TeVEarly2018Collision --step SIM --geometry DB:Extended --filein file:HIG-RunIISummer19UL18wmLHEGEN-00265.root --era Run2_2018 --runUnscheduled --no_exec --mc -n 1037 --nThreads 1
...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file:HIG-RunIISummer19UL18wmLHEGEN-00265.root'),
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:HIG-RunIISummer20UL18SIM-00001.root'),
...
if hasattr(process,"eventMaker"):
    ...
    process.eventMaker.datasetName = cms.string('/NMSSM_XYH_Y_tautau_H_gg_MX_400_MY_70_STEP2')
