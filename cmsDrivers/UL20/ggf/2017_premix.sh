...
# cmsDriver command
cmsDriver.py  --python_filename HIG-RunIISummer20UL17DIGIPremix-01169_1_cfg.py --eventcontent PREMIXRAW --customise Configuration/DataProcessing/Utils.addMonitoring --datatier GEN-SIM-DIGI --fileout file:HIG-RunIISummer20UL17DIGIPremix-01169.root --pileup_input "dbs:/Neutrino_E-10_gun/RunIISummer20ULPrePremix-UL17_106X_mc2017_realistic_v6-v3/PREMIX" --conditions 106X_mc2017_realistic_v6 --step DIGI,DATAMIX,L1,DIGI2RAW --procModifiers premix_stage2 --geometry DB:Extended --filein file:HIG-RunIISummer20UL17SIM-01169.root --datamix PreMix --era Run2_2017 --runUnscheduled --no_exec --mc -n $EVENTS  --nThreads 1 || exit $? ;
