...
process.externalLHEProducer = cms.EDProducer("ExternalLHEProducer",
    args = cms.vstring('/cvmfs/cms.cern.ch/phys_generator/gridpacks/UL/13TeV/madgraph/V5_2.6.5/doubleHiggs/Graviton_GF_HH/BulkGraviton_hh_GF_HH_narrow_M500_slc7_amd64_gcc700_CMSSW_9_3_16_tarball.tar.xz'),
