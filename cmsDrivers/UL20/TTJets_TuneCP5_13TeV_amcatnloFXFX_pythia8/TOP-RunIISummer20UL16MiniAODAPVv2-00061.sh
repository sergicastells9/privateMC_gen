...
# cmsDriver command
cmsDriver.py  --python_filename TOP-RunIISummer20UL16MiniAODAPVv2-00061_1_cfg.py --eventcontent MINIAODSIM --customise Configuration/DataProcessing/Utils.addMonitoring --datatier MINIAODSIM --fileout file:TOP-RunIISummer20UL16MiniAODAPVv2-00061.root --conditions 106X_mcRun2_asymptotic_preVFP_v11 --step PAT --procModifiers run2_miniAOD_UL --geometry DB:Extended --filein "dbs:/TTJets_TuneCP5_13TeV-amcatnloFXFX-pythia8/RunIISummer20UL16RECOAPV-106X_mcRun2_asymptotic_preVFP_v8-v1/AODSIM" --era Run2_2016_HIPM --runUnscheduled --no_exec --mc -n $EVENTS --nThreads 1 || exit $? ;
