...
# with command line options: Configuration/GenProduction/python/HIG-RunIISummer20UL16wmLHEGENAPV-02285-fragment.py --python_filename HIG-RunIISummer20UL16wmLHEGENAPV-02285_1_cfg.py --eventcontent RAWSIM,LHE --customise Configuration/DataProcessing/Utils.addMonitoring --datatier GEN,LHE --fileout file:HIG-RunIISummer20UL16wmLHEGENAPV-02285.root --conditions 106X_mcRun2_asymptotic_preVFP_v8 --beamspot Realistic25ns13TeV2016Collision --step LHE,GEN --geometry DB:Extended --era Run2_2016_HIPM --no_exec --mc -n 5064 --nThreads 1
...
process.maxEvents = cms.untracked.PSet(
    input = cms.untracked.int32(5064)
)
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/GenProduction/python/HIG-RunIISummer20UL16wmLHEGENAPV-02285-fragment.py nevts:5064'),
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:HIG-RunIISummer20UL16wmLHEGENAPV-02285.root'),
...
process.LHEoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:HIG-RunIISummer20UL16wmLHEGENAPV-02285_inLHE.root'),
...
process.externalLHEProducer = cms.EDProducer("ExternalLHEProducer",
    args = cms.vstring('/cvmfs/cms.cern.ch/phys_generator/gridpacks/UL/13TeV/madgraph/V5_2.6.5/doubleHiggs/Radion_HH/Radion_hh_narrow_M1000_slc7_amd64_gcc700_CMSSW_9_3_16_tarball.tar.xz'),
    nEvents = cms.untracked.uint32(5064),
