...
# with command line options: Configuration/GenProduction/python/HIG-RunIIFall17wmLHEGS-05119-fragment.py --python_filename HIG-RunIIFall17wmLHEGS-05119_1_cfg.py --eventcontent RAWSIM,LHE --customise Configuration/DataProcessing/Utils.addMonitoring --datatier GEN-SIM,LHE --fileout file:HIG-RunIIFall17wmLHEGS-05119.root --conditions 93X_mc2017_realistic_v3 --beamspot Realistic25ns13TeVEarly2017Collision --customise_commands process.RandomNumberGeneratorService.externalLHEProducer.initialSeed=int(76) --step LHE,GEN,SIM --geometry DB:Extended --era Run2_2017 --no_exec --mc -n 354
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/GenProduction/python/HIG-RunIIFall17wmLHEGS-05119-fragment.py nevts:354'),
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:HIG-RunIIFall17wmLHEGS-05119.root'),
...
process.LHEoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:HIG-RunIIFall17wmLHEGS-05119_inLHE.root'),
...
process.generator = cms.EDFilter("Pythia8HadronizerFilter",
    PythiaParameters = cms.PSet(
        parameterSets = cms.vstring('pythia8CommonSettings', 
            ...
            'processParameters'),
        processParameters = cms.vstring('15:onMode = on', 
            '24:mMin = 0.05', 
            '24:onMode = off', 
...
process.externalLHEProducer = cms.EDProducer("ExternalLHEProducer",
    ...
    nEvents = cms.untracked.uint32(354),
