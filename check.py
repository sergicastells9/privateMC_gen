...
from update_pset_NMSSM import edit_pset_NMSSM, edit_pset_gghh
...
condor_submit_params={
        "sites": "SDSC-PRP", # other_sites can be good_sites, your own list, etc.
				#"sites": "T2_US_UCSD,T2_US_CALTECH,T2_US_MIT,T2_US_WISCONSIN,T2_US_Nebraska,T2_US_Purdue,T2_US_Vanderbilt,T2_US_Florida",
        "classads": [
...
runall("nanoAOD_runII_20UL_test", 10, 5)
