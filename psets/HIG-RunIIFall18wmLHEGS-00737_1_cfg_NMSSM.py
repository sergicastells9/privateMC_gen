...
# with command line options: Configuration/GenProduction/python/HIG-RunIIFall18wmLHEGS-00737-fragment.py --fileout file:HIG-RunIIFall18wmLHEGS-00737.root --mc --eventcontent RAWSIM,LHE --datatier GEN-SIM,LHE --conditions 102X_upgrade2018_realistic_v11 --beamspot Realistic25ns13TeVEarly2018Collision --step LHE,GEN,SIM --nThreads 8 --geometry DB:Extended --era Run2_2018 --python_filename HIG-RunIIFall18wmLHEGS-00737_1_cfg.py --no_exec --customise Configuration/DataProcessing/Utils.addMonitoring --customise_commands process.RandomNumberGeneratorService.externalLHEProducer.initialSeed=int(86) -n 1063
...
process.maxEvents = cms.untracked.PSet(
    input = cms.untracked.int32(1063)
)
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/GenProduction/python/HIG-RunIIFall18wmLHEGS-00737-fragment.py nevts:1063'),
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:HIG-RunIIFall18wmLHEGS-00737.root'),
...
process.LHEoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:HIG-RunIIFall18wmLHEGS-00737_inLHE.root'),
...
process.externalLHEProducer = cms.EDProducer("ExternalLHEProducer",
    args = cms.vstring('/hadoop/cms/store/user/fsetti/IC_gridpacks/NMSSM_XYH_Y_gg_H_tautau_MX_1000_MY_100_slc7_amd64_gcc700_CMSSW_10_6_19_tarball.tar.xz'),
    nEvents = cms.untracked.uint32(1063),
...
process.RandomNumberGeneratorService.externalLHEProducer.initialSeed=int(86)
