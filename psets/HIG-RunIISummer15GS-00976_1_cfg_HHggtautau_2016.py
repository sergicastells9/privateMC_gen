...
process.maxEvents = cms.untracked.PSet(
    input = cms.untracked.int32(324)
)

# Input source
process.source = cms.Source("PoolSource",
    secondaryFileNames = cms.untracked.vstring(),
    fileNames = cms.untracked.vstring("file:/home/users/hmei/myWorkspace/privateMC_gen/CMSSW_7_1_20/src/HIG-RunIIWinter15wmLHE-00576.root"),
...
process.configurationMetadata = cms.untracked.PSet(
    ...
    annotation = cms.untracked.string('Configuration/GenProduction/python/ThirteenTeV/Hadronizer_TuneCUETP8M1_13TeV_generic_LHE_pythia8_cff.py nevts:324'),
