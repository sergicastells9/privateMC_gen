...
# with command line options: Configuration/GenProduction/python/HIG-RunIISummer15wmLHEGS-02729-fragment.py --python_filename HIG-RunIISummer15wmLHEGS-02729_1_cfg.py --eventcontent RAWSIM,LHE --customise SLHCUpgradeSimulations/Configuration/postLS1Customs.customisePostLS1,Configuration/DataProcessing/Utils.addMonitoring --datatier GEN-SIM,LHE --fileout file:HIG-RunIISummer15wmLHEGS-02729.root --conditions MCRUN2_71_V1::All --beamspot Realistic50ns13TeVCollision --customise_commands process.RandomNumberGeneratorService.externalLHEProducer.initialSeed=int(87) --step LHE,GEN,SIM --magField 38T_PostLS1 --no_exec --mc -n 112
...
process.configurationMetadata = cms.untracked.PSet(
    ...
    annotation = cms.untracked.string('Configuration/GenProduction/python/HIG-RunIISummer15wmLHEGS-02729-fragment.py nevts:112'),
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:HIG-RunIISummer15wmLHEGS-02729.root'),
...
process.LHEoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:HIG-RunIISummer15wmLHEGS-02729_inLHE.root'),
    dataset = cms.untracked.PSet(
        filterName = cms.untracked.string(''),
...
process.externalLHEProducer = cms.EDProducer("ExternalLHEProducer",
    nEvents = cms.untracked.uint32(112),
...
process.RandomNumberGeneratorService.externalLHEProducer.initialSeed=int(87)
